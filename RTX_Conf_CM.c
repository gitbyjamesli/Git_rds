...
//                         <96=> 96 entries
//   <i> ISR functions store requests to this buffer, //当从中断程序冲被调用时，侦察功能请求缓冲区
//   <i> when they are called from the iterrupt handler.
//   <i> Default: 16 entries
#ifndef OS_FIFOSZ
 #define OS_FIFOSZ      16*2
#endif
...
void os_error (U32 err_code) {
  ...
  for (;;)
  {
	  GPIO_SetBits(GPIOB,GPIO_Pin_14);// ERR灯	 亮
	  Delay_ms(1000);
	  GPIO_ResetBits(GPIOB,GPIO_Pin_14);// ERR灯	灭
	  Delay_ms(1000);
  }
}
